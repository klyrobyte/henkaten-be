...
Route::middleware(['auth', 'sc.guard'])->prefix('admin')->name('admin.')->group(function () {
     ...
     Route::middleware('role:admin')->prefix('users')->name('users.')->group(function () {
          ...
          Route::post('/', [UserController::class, 'store'])->name('store')
               ->middleware('log.deprecated');
          // DEPRECATED — migrate callers to PUT /api/users/{user}
          Route::put('/{user}', [UserController::class, 'update'])->name('update')
               ->middleware('log.deprecated');
          // DEPRECATED — migrate callers to DELETE /api/users/{user}
     ...
     // ── Skill Management ───────────────────────────────────────────────────
     Route::middleware('role:admin,gl,tl')->prefix('skills')->name('skills.')->group(function () {
     ...
     // ── Floor Plan Manager ────────────────────────────────────────────────
     Route::middleware('role:admin')->prefix('floor-plan-manager')->name('floor-plan-manager.')->group(function () {
     ...
     Route::middleware('role:admin,gl,tl')->prefix('mesinmg')->name('mesinmg.')->group(function () {
     ...
     Route::middleware('role:admin,gl,tl')->prefix('members')->name('members.')->group(function () {
