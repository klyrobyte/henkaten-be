...
return [
    ...
    'laravel' => [
        ...
        'middleware' => ['web', 'auth', 'docs.restrict'],
    ],
    ...
    'auth' => [
        ...
        // You can then use @Nahkan ketauan, mau ngapain coba wkwkwk, kalo u admin bisa baca panduan dokumentasi di henkaten.md (@RizkyDaffy) or @authenticated on individual endpoints to change their status from the default.
        'default' => true,
        ...
        'use_value' => env('APP_API_SECRET'),

        // Placeholder your users will see for the auth parameter in the example requests.
        // Set this to null if you want Scribe to use a random value as placeholder instead.
        'placeholder' => '{HMAC_SHA256_TOKEN}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'For service clients, provide the SHA-256 HMAC of "henkaten-api" using your APP_API_SECRET.',
    ],
