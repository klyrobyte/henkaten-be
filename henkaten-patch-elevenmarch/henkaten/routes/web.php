...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ── Problem Log ──────────────────────────────────────────────────
    // Route tetap ada agar AJAX dari page Laporan bisa memanggil endpoint ini.
    // Halaman /admin/logs masih bisa diakses langsung via URL jika diperlukan,
    // tapi TIDAK ditampilkan di bottom nav lagi (hapus dari admin.blade.php).
