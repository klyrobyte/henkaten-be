...
@section('title', 'Mesin')
@section('content')
<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;gap:16px;padding:24px;text-align:center">
    <div style="font-size:48px">⚙️</div>
    <div style="font-family:'Orbitron',sans-serif;font-size:14px;font-weight:700;color:var(--navy)">Halaman Mesin Dipindah</div>
    <div style="font-size:13px;color:#888;max-width:280px">Status mesin sekarang tersedia langsung di halaman Dashboard.</div>
