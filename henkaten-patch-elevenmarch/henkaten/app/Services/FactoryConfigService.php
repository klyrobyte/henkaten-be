...
class FactoryConfigService
{
    ...
    private array $groups = [
        'Factory 2' => [
            ...
            [
                'title' => 'Robot Assy junbiki trim group',
                'machines' => [
                    'Robot 1',
                    'Robot 2',
                    'Robot 3',
        ...
        'Factory 3 & 4' => [
            ...
            [
                'title' => 'Factory 3 - Resin Injection',
                'machines' => [
                    '#01-1300T',
                    '#02-1300T',
                    'Q/Gate D.G.',
            ...
            [
                'title' => 'Factory 4 - Resin Injection',
                'machines' => [
                    '#01-350T',
                    '#08-350T',
                    'Crane&Matl',
    ...
    private array $circleCount = [
        'Factory 2' => [
            ...
            'Robot Assy Junbiki Trim Group' => ['Robot 1' => 2, 'Robot 2' => 2, 'Robot 3' => 1, 'Robot 4' => 2, 'Robot 5' => 2, 'Quality' => 1],
    ...
    public function getAllMachines(string $factory, bool $excludeKeyPersons = false): array
    {
        ...
        foreach ($this->groups[$factory] ?? [] as $group) {
            if ($excludeKeyPersons && str_contains($group['title'], 'Key Persons', 'Factory 3 - Robot Assy'))
                continue;
    ...
    /** Cek apakah grup adalah Key Robot */
    public function isKeyRobot(string $groupTitle): bool
    {
        return str_contains($groupTitle, 'Factory 3 - Robot Assy');
    }
