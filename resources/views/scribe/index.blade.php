...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://192.168.247.152:8000";
        var useCsrf = Boolean();
            ...
            <ul id="tocify-header-attendance" class="tocify-header">
                ...
                <ul id="tocify-subheader-attendance" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="attendance-GETapi-attendance-data">
                        <a href="#attendance-GETapi-attendance-data">Ambil data absen + data chart untuk AJAX
                            auto-refresh
            ...
            <ul id="tocify-header-endpoints" class="tocify-header">
                ...
                <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-machines-all">
                        <a href="#endpoints-GETapi-machines-all">Get ALL machines (for dropdown/selection, not floor
                            plan display)
                            GET /api/machines/all</a>
                    </li>
                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-machines-floor-plan">
                        <a href="#endpoints-GETapi-machines-floor-plan">Get machines with floor plan coordinates and
                            current status
            ...
            <ul id="tocify-header-factory" class="tocify-header">
                ...
                <ul id="tocify-subheader-factory" class="tocify-subheader">
                    ...
                    <li class="tocify-item level-2" data-unique="factory-PATCHapi-factories-reorder">
                        <a href="#factory-PATCHapi-factories-reorder">PATCH /admin/api/factories/reorder - bulk update
                            order_index</a>
                    </li>
                </ul>
            </ul>
            ...
            <ul id="tocify-header-machine" class="tocify-header">
                ...
                <ul id="tocify-subheader-machine" class="tocify-subheader">
                    ...
                    <li class="tocify-item level-2"
                        data-unique="machine-PATCHapi-machines--machine_id--floor-coordinates">
                        <a href="#machine-PATCHapi-machines--machine_id--floor-coordinates">Update floor plan
                            coordinates for a machine
            ...
            <ul id="tocify-header-replacement" class="tocify-header">
                ...
                <ul id="tocify-subheader-replacement" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="replacement-GETapi-replacements">
                        <a href="#replacement-GETapi-replacements">Ambil pengganti aktif (hanya yang member aslinya
                            masih absen)
                    ...
                    <li class="tocify-item level-2" data-unique="replacement-DELETEapi-replacements--replacement_id-">
                        <a href="#replacement-DELETEapi-replacements--replacement_id-">Hapus pengganti manual (tombol
                            batalkan)
            ...
            <ul id="tocify-header-section" class="tocify-header">
                ...
                <ul id="tocify-subheader-section" class="tocify-subheader">
                    ...
                    <li class="tocify-item level-2" data-unique="section-PATCHapi-sections-reorder">
                        <a href="#section-PATCHapi-sections-reorder">PATCH /admin/api/sections/reorder - bulk update
                            order_index</a>
                    </li>
                </ul>
            </ul>
...
- **Service Clients**: Include the `X-App-Secret` header containing `hash_hmac('sha256', 'henkaten-api', APP_API_SECRET)`.</code></pre>
            ...
            <p>To authenticate requests, include a <strong><code>X-App-Secret</code></strong> header with the value
                <strong><code>"{HMAC_SHA256_TOKEN}"</code></strong>.</p>
    ...
    "http://192.168.247.152:8000/api/absence/save" \
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-absence-save" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-absence-save"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-absence-save" data-method="POST" data-path="api/absence/save" data-authed="1"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        id="btn-tryout-POSTapi-absence-save" onclick="tryItOut('POSTapi-absence-save');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-absence-save" onclick="cancelTryOut('POSTapi-absence-save');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-absence-save" data-initial-text="Send Request 💥"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-absence-save" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-absence-save"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-absence-save"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal" data-endpoint="POSTapi-absence-save"
                        value="2026-05-20T05:58:41" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-absence-save"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-absence-save" value="B"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="records" data-endpoint="POSTapi-absence-save"
    ...
    --get "http://192.168.247.152:8000/api/absence/data" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/absence/data"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-absence-data" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-absence-data"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-absence-data" data-method="GET" data-path="api/absence/data" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-absence-data" onclick="tryItOut('GETapi-absence-data');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-absence-data" onclick="cancelTryOut('GETapi-absence-data');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-absence-data" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-absence-data" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-absence-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-absence-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-absence-candidates">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/absence/candidates" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/absence/candidates"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-absence-candidates" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-absence-candidates"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-absence-candidates" data-method="GET" data-path="api/absence/candidates"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-absence-candidates" onclick="tryItOut('GETapi-absence-candidates');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-absence-candidates" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-absence-candidates" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-absence-candidates" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-absence-candidates"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-absence-report">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/absence/report" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/absence/report"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-absence-report" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-absence-report"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-absence-report" data-method="GET" data-path="api/absence/report" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-absence-report" onclick="tryItOut('GETapi-absence-report');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-absence-report" onclick="cancelTryOut('GETapi-absence-report');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-absence-report" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-absence-report" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-absence-report"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-absence-report"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-POSTapi-absence-rebuild-summary">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/absence/rebuild-summary" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-absence-rebuild-summary" data-method="POST" data-path="api/absence/rebuild-summary"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-absence-rebuild-summary" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-absence-rebuild-summary" value="{HMAC_SHA256_TOKEN}"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-absence-rebuild-summary" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal"
                        data-endpoint="POSTapi-absence-rebuild-summary" value="2026-05-20T05:58:41"
                        data-component="body">
                    <br>
                    <p>Must be a valid date. Example: <code>2026-05-20T05:58:41</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory"
                        data-endpoint="POSTapi-absence-rebuild-summary" value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift"
                        data-endpoint="POSTapi-absence-rebuild-summary" value="A" data-component="body">
                    <br>
            ...
            <span id="example-requests-GETapi-absence-export">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/absence/export" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/absence/export"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-absence-export" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-absence-export"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-absence-export" data-method="GET" data-path="api/absence/export" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-absence-export" onclick="tryItOut('GETapi-absence-export');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-absence-export" onclick="cancelTryOut('GETapi-absence-export');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-absence-export" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-absence-export" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-absence-export"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-absence-export"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-absence-export-excel">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/absence/export-excel" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/absence/export-excel"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-absence-export-excel" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-absence-export-excel"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-absence-export-excel" data-method="GET" data-path="api/absence/export-excel"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-absence-export-excel" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-absence-export-excel" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-absence-export-excel" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-absence-export-excel"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-POSTapi-assignment-save">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/assignment/save" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-assignment-save" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-assignment-save"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-assignment-save" data-method="POST" data-path="api/assignment/save" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-assignment-save" onclick="tryItOut('POSTapi-assignment-save');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-assignment-save" onclick="cancelTryOut('POSTapi-assignment-save');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-assignment-save" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-assignment-save" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-assignment-save"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-assignment-save"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal" data-endpoint="POSTapi-assignment-save"
                        value="2026-05-20T05:58:42" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-assignment-save"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-assignment-save"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="assignments" data-endpoint="POSTapi-assignment-save"
                        value="" data-component="body">
                    <br>
            ...
            <span id="example-requests-GETapi-assignment-data">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/assignment/data" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/assignment/data"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-assignment-data" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-assignment-data"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-assignment-data" data-method="GET" data-path="api/assignment/data" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-assignment-data" onclick="tryItOut('GETapi-assignment-data');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-assignment-data" onclick="cancelTryOut('GETapi-assignment-data');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-assignment-data" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-assignment-data" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-assignment-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-assignment-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-assignment-candidates">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/assignment/candidates" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/assignment/candidates"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-assignment-candidates" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-assignment-candidates"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-assignment-candidates" data-method="GET" data-path="api/assignment/candidates"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-assignment-candidates" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-assignment-candidates" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-assignment-candidates" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-assignment-candidates"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-POSTapi-assignment-sync-absen">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/assignment/sync-absen" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-assignment-sync-absen" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-assignment-sync-absen"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-assignment-sync-absen" data-method="POST" data-path="api/assignment/sync-absen"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-assignment-sync-absen" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-assignment-sync-absen" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-assignment-sync-absen" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-assignment-sync-absen"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-attendance-data">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/attendance/data" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/attendance/data"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-attendance-data" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-attendance-data"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-attendance-data" data-method="GET" data-path="api/attendance/data" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-attendance-data" onclick="tryItOut('GETapi-attendance-data');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-attendance-data" onclick="cancelTryOut('GETapi-attendance-data');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-attendance-data" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-attendance-data" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-attendance-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-attendance-data"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-status">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/status" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/status"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-status" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-status"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-status" data-method="GET" data-path="api/status" data-authed="1" data-hasfiles="0"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-status" onclick="tryItOut('GETapi-status');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-status" onclick="cancelTryOut('GETapi-status');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-status" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-status" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-status"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-status"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-POSTapi-context">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/context" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-context" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-context"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-context" data-method="POST" data-path="api/context" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-context" onclick="tryItOut('POSTapi-context');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-context" onclick="cancelTryOut('POSTapi-context');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-context" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-context" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-context"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-context"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-context"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-context" value="A"
                        data-component="body">
                    <br>
                    <p>Example: <code>A</code></p>
                    Must be one of:
            ...
            <span id="example-requests-GETapi-machines-all">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/machines/all" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/machines/all"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-machines-all" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-machines-all"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-machines-all" data-method="GET" data-path="api/machines/all" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-machines-all" onclick="tryItOut('GETapi-machines-all');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-machines-all" onclick="cancelTryOut('GETapi-machines-all');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-machines-all" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-machines-all" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-machines-all"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-machines-all"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-machines-floor-plan">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/machines/floor-plan" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/machines/floor-plan"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-machines-floor-plan" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-machines-floor-plan"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-machines-floor-plan" data-method="GET" data-path="api/machines/floor-plan"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-machines-floor-plan" onclick="tryItOut('GETapi-machines-floor-plan');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-machines-floor-plan" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-machines-floor-plan" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-machines-floor-plan" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-machines-floor-plan"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-machines--id--floor-plan">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/machines/architecto/floor-plan" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/machines/architecto/floor-plan"
);
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-machines--id--floor-plan" data-method="GET" data-path="api/machines/{id}/floor-plan"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-machines--id--floor-plan" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-machines--id--floor-plan" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-machines--id--floor-plan" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="id" data-endpoint="GETapi-machines--id--floor-plan"
            ...
            <span id="example-requests-GETapi-factories">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/factories" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/factories"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-factories" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-factories"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-factories" data-method="GET" data-path="api/factories" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-factories" onclick="tryItOut('GETapi-factories');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-factories" onclick="cancelTryOut('GETapi-factories');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-factories" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-factories" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-factories"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-factories"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-factories" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-factories"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-factories" data-method="POST" data-path="api/factories" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-factories" onclick="tryItOut('POSTapi-factories');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-factories" onclick="cancelTryOut('POSTapi-factories');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-factories" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-factories" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-factories"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-factories"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-factories" value="b"
                        data-component="body">
                    <br>
    ...
    "http://192.168.247.152:8000/api/factories/3" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
</code></pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PUTapi-factories--factory_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-factories--factory_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-factories--factory_id-" data-method="PUT" data-path="api/factories/{factory_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-factories--factory_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PUTapi-factories--factory_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-factories--factory_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-factories--factory_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="factory_id"
                        data-endpoint="PUTapi-factories--factory_id-" value="3" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="PUTapi-factories--factory_id-"
                        value="" data-component="body">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-factories--factory_id-" data-method="DELETE" data-path="api/factories/{factory_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-factories--factory_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-factories--factory_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-factories--factory_id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="factory_id"
                        data-endpoint="DELETEapi-factories--factory_id-" value="3" data-component="url">
                    <br>
                    <p>The ID of the factory. Example: <code>3</code></p>
                </div>
            </form>

            <h2 id="factory-PATCHapi-factories-reorder">PATCH /admin/api/factories/reorder - bulk update order_index
            </h2>
    ...
    "http://192.168.247.152:8000/api/factories/reorder" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PATCHapi-factories-reorder" hidden>
                <blockquote>Received response<span id="execution-response-status-PATCHapi-factories-reorder"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-factories-reorder" data-method="PATCH" data-path="api/factories/reorder"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PATCHapi-factories-reorder" onclick="tryItOut('PATCHapi-factories-reorder');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PATCHapi-factories-reorder" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-factories-reorder" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PATCHapi-factories-reorder" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PATCHapi-factories-reorder"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="order.0.id"
                                data-endpoint="PATCHapi-factories-reorder" value="16" data-component="body">
                            <br>
                            <p>The <code>id</code> of an existing record in the factories table. Example:
                                <code>16</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="order.0.order_index"
                                data-endpoint="PATCHapi-factories-reorder" value="16" data-component="body">
                            <br>
            ...
            <span id="example-requests-GETapi-logs-list">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/logs/list" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/logs/list"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-logs-list" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-logs-list"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-logs-list" data-method="GET" data-path="api/logs/list" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-logs-list" onclick="tryItOut('GETapi-logs-list');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-logs-list" onclick="cancelTryOut('GETapi-logs-list');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-logs-list" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-logs-list" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-logs-list"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-logs-list"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-logs-combined">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/logs/combined" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/logs/combined"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-logs-combined" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-logs-combined"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-logs-combined" data-method="GET" data-path="api/logs/combined" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-logs-combined" onclick="tryItOut('GETapi-logs-combined');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-logs-combined" onclick="cancelTryOut('GETapi-logs-combined');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-logs-combined" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-logs-combined" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-logs-combined"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-logs-combined"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-POSTapi-logs">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/logs" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-logs" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-logs"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-logs" data-method="POST" data-path="api/logs" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-logs" onclick="tryItOut('POSTapi-logs');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-logs" onclick="cancelTryOut('POSTapi-logs');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-logs" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-logs" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-logs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-logs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal" data-endpoint="POSTapi-logs"
                        value="2026-05-20T05:58:40" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-logs"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-logs" value="B"
                        data-component="body">
                    <br>
                    <p>Example: <code>B</code></p>
                    Must be one of:
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="jenis" data-endpoint="POSTapi-logs" value="Machine"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="lokasi" data-endpoint="POSTapi-logs"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="waktu_mulai" data-endpoint="POSTapi-logs"
                        value="05:58" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="waktu_selesai" data-endpoint="POSTapi-logs"
                        value="05:58" data-component="body">
                    <br>
                    <p>Must be a valid date in the format <code>H:i</code>. Example: <code>05:58</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="status" data-endpoint="POSTapi-logs" value="closed"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="deskripsi" data-endpoint="POSTapi-logs"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="cause" data-endpoint="POSTapi-logs"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="countermeasure" data-endpoint="POSTapi-logs"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="pic" data-endpoint="POSTapi-logs" value="architecto"
                        data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
            ...
            <span id="example-requests-PATCHapi-logs--log_id--close">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PATCH \
    "http://192.168.247.152:8000/api/logs/1/close" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PATCHapi-logs--log_id--close" hidden>
                <blockquote>Received response<span id="execution-response-status-PATCHapi-logs--log_id--close"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-logs--log_id--close" data-method="PATCH" data-path="api/logs/{log_id}/close"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PATCHapi-logs--log_id--close" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-logs--log_id--close" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PATCHapi-logs--log_id--close" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PATCHapi-logs--log_id--close"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="log_id"
                        data-endpoint="PATCHapi-logs--log_id--close" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="countermeasure"
                        data-endpoint="PATCHapi-logs--log_id--close" value="b" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="waktu_selesai"
                        data-endpoint="PATCHapi-logs--log_id--close" value="05:58" data-component="body">
                    <br>
                    <p>Must be a valid date in the format <code>H:i</code>. Example: <code>05:58</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-PATCHapi-logs--log_id--reopen">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PATCH \
    "http://192.168.247.152:8000/api/logs/1/reopen" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PATCHapi-logs--log_id--reopen" hidden>
                <blockquote>Received response<span id="execution-response-status-PATCHapi-logs--log_id--reopen"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-logs--log_id--reopen" data-method="PATCH" data-path="api/logs/{log_id}/reopen"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PATCHapi-logs--log_id--reopen" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-logs--log_id--reopen" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PATCHapi-logs--log_id--reopen" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PATCHapi-logs--log_id--reopen"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="log_id"
                        data-endpoint="PATCHapi-logs--log_id--reopen" value="1" data-component="url">
                    <br>
                    <p>The ID of the log. Example: <code>1</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-PATCHapi-logs--log_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PATCH \
    "http://192.168.247.152:8000/api/logs/1" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PATCHapi-logs--log_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PATCHapi-logs--log_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-logs--log_id-" data-method="PATCH" data-path="api/logs/{log_id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PATCHapi-logs--log_id-" onclick="tryItOut('PATCHapi-logs--log_id-');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-PATCHapi-logs--log_id-" onclick="cancelTryOut('PATCHapi-logs--log_id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PATCHapi-logs--log_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-logs--log_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="PATCHapi-logs--log_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PATCHapi-logs--log_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="log_id"
                        data-endpoint="PATCHapi-logs--log_id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the log. Example: <code>1</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="waktu_mulai" data-endpoint="PATCHapi-logs--log_id-"
                        value="05:58" data-component="body">
                    <br>
                    <p>Must be a valid date in the format <code>H:i</code>. Example: <code>05:58</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="waktu_selesai" data-endpoint="PATCHapi-logs--log_id-"
                        value="05:58" data-component="body">
                    <br>
                    <p>Must be a valid date in the format <code>H:i</code>. Example: <code>05:58</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-DELETEapi-logs--log_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-logs--log_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-logs--log_id-" data-method="DELETE" data-path="api/logs/{log_id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-DELETEapi-logs--log_id-" onclick="tryItOut('DELETEapi-logs--log_id-');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-DELETEapi-logs--log_id-" onclick="cancelTryOut('DELETEapi-logs--log_id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-logs--log_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-logs--log_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="DELETEapi-logs--log_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-logs--log_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="log_id"
                        data-endpoint="DELETEapi-logs--log_id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the log. Example: <code>1</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-POSTapi-machines-photo">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/machines/photo" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "factory=architecto"\
    --form "machine_name=architecto"\
    --form "photo=@C:\Users\Daffy\AppData\Local\Temp\phpC983.tmp" </code></pre>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-machines-photo" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-machines-photo"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-machines-photo" data-method="POST" data-path="api/machines/photo" data-authed="1"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-machines-photo" onclick="tryItOut('POSTapi-machines-photo');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-machines-photo" onclick="cancelTryOut('POSTapi-machines-photo');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-machines-photo" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-machines-photo" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-machines-photo"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-machines-photo"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-machines-photo"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="machine_name" data-endpoint="POSTapi-machines-photo"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="file" style="display: none" name="photo" data-endpoint="POSTapi-machines-photo"
                        value="" data-component="body">
                    <br>
                    <p>Must be an image. Must not be greater than 3072 kilobytes. Example:
                        <code>C:\Users\Daffy\AppData\Local\Temp\phpC983.tmp</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-POSTapi-machines-status">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/machines/status" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-machines-status" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-machines-status"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-machines-status" data-method="POST" data-path="api/machines/status" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-machines-status" onclick="tryItOut('POSTapi-machines-status');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-machines-status" onclick="cancelTryOut('POSTapi-machines-status');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-machines-status" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-machines-status" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-machines-status"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-machines-status"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal" data-endpoint="POSTapi-machines-status"
                        value="2026-05-20T05:58:44" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-machines-status"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-machines-status"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="machine_name" data-endpoint="POSTapi-machines-status"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="status" data-endpoint="POSTapi-machines-status"
                        value="normal" data-component="body">
                    <br>
            ...
            <span id="example-requests-GETapi-machines-lights">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/machines/lights" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/machines/lights"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-machines-lights" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-machines-lights"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-machines-lights" data-method="GET" data-path="api/machines/lights" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-machines-lights" onclick="tryItOut('GETapi-machines-lights');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-machines-lights" onclick="cancelTryOut('GETapi-machines-lights');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-machines-lights" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-machines-lights" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-machines-lights"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-machines-lights"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-machines-statuses">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/machines/statuses" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/machines/statuses"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-machines-statuses" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-machines-statuses"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-machines-statuses" data-method="GET" data-path="api/machines/statuses" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-machines-statuses" onclick="tryItOut('GETapi-machines-statuses');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-machines-statuses" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-machines-statuses" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-machines-statuses" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-machines-statuses"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="machine-PATCHapi-machines--machine_id--floor-coordinates">Update floor plan coordinates for a
                machine
            ...
            <span id="example-requests-PATCHapi-machines--machine_id--floor-coordinates">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PATCH \
    "http://192.168.247.152:8000/api/machines/1/floor-coordinates" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-machines--machine_id--floor-coordinates" data-method="PATCH"
                data-path="api/machines/{machine_id}/floor-coordinates" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="machine_id"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="floor_cx"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="4326.41688"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="floor_cy"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="4326.41688"
                        data-component="body">
                    <br>
                    <p>Example: <code>4326.41688</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="floor_plan"
                        data-endpoint="PATCHapi-machines--machine_id--floor-coordinates" value="architecto"
                        data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-members-list">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/members/list" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/members/list"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-members-list" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-members-list"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-members-list" data-method="GET" data-path="api/members/list" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-members-list" onclick="tryItOut('GETapi-members-list');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-members-list" onclick="cancelTryOut('GETapi-members-list');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-members-list" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-members-list" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-members-list"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-members-list"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-members--member_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/members/5" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/members/5"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-members--member_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-members--member_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-members--member_id-" data-method="GET" data-path="api/members/{member_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-members--member_id-" onclick="tryItOut('GETapi-members--member_id-');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-members--member_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-members--member_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-members--member_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-members--member_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="member_id"
                        data-endpoint="GETapi-members--member_id-" value="5" data-component="url">
                    <br>
            ...
            <span id="example-requests-POSTapi-members">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/members" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-members" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-members"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-members" data-method="POST" data-path="api/members" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-members" onclick="tryItOut('POSTapi-members');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-members" onclick="cancelTryOut('POSTapi-members');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-members" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-members" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-members"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-members"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PUTapi-members--member_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-members--member_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-members--member_id-" data-method="PUT" data-path="api/members/{member_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PUTapi-members--member_id-" onclick="tryItOut('PUTapi-members--member_id-');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-members--member_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PUTapi-members--member_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-members--member_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-members--member_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="member_id"
                        data-endpoint="PUTapi-members--member_id-" value="5" data-component="url">
                    <br>
                    <p>The ID of the member. Example: <code>5</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-DELETEapi-members-clear-all">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request DELETE \
    "http://192.168.247.152:8000/api/members/clear-all" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-DELETEapi-members-clear-all" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-members-clear-all"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-members-clear-all" data-method="DELETE" data-path="api/members/clear-all"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-members-clear-all" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-members-clear-all" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-members-clear-all" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-members-clear-all"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-DELETEapi-members--member_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-members--member_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-members--member_id-" data-method="DELETE" data-path="api/members/{member_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-members--member_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-members--member_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-members--member_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-members--member_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="member_id"
                        data-endpoint="DELETEapi-members--member_id-" value="5" data-component="url">
                    <br>
                    <p>The ID of the member. Example: <code>5</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-POSTapi-members-import">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request POST \
    "http://192.168.247.152:8000/api/members/import" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-members-import" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-members-import"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-members-import" data-method="POST" data-path="api/members/import" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-members-import" onclick="tryItOut('POSTapi-members-import');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-members-import" onclick="cancelTryOut('POSTapi-members-import');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-members-import" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-members-import" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-members-import"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-members-import"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="text" style="display: none" name="members.0.name"
                                data-endpoint="POSTapi-members-import" value="b" data-component="body">
                            <br>
                            <p>Must not be greater than 100 characters. Example: <code>b</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="text" style="display: none" name="members.0.factory"
                                data-endpoint="POSTapi-members-import" value="architecto" data-component="body">
                            <br>
                            <p>Example: <code>architecto</code></p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            &nbsp;
                            <input type="text" style="display: none" name="members.0.shift"
                                data-endpoint="POSTapi-members-import" value="B" data-component="body">
                            <br>
                            <p>Example: <code>B</code></p>
                            Must be one of:
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <label data-endpoint="POSTapi-members-import" style="display: none">
                        <input type="radio" name="replace" value="true" data-endpoint="POSTapi-members-import"
                            data-component="body">
                        <code>true</code>
                    </label>
                    <label data-endpoint="POSTapi-members-import" style="display: none">
                        <input type="radio" name="replace" value="false" data-endpoint="POSTapi-members-import"
                            data-component="body">
                        <code>false</code>
                    </label>
                    <br>
            ...
            <span id="example-requests-GETapi-members-export">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/members/export" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/members/export"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-members-export" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-members-export"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-members-export" data-method="GET" data-path="api/members/export" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-members-export" onclick="tryItOut('GETapi-members-export');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-members-export" onclick="cancelTryOut('GETapi-members-export');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-members-export" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-members-export" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-members-export"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-members-export"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-members-template">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/members/template" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/members/template"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-members-template" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-members-template"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-members-template" data-method="GET" data-path="api/members/template" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-members-template" onclick="tryItOut('GETapi-members-template');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-members-template" onclick="cancelTryOut('GETapi-members-template');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-members-template" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-members-template" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-members-template"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-members-template"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <span id="example-requests-GETapi-replacements">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/replacements" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/replacements"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-replacements" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-replacements"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-replacements" data-method="GET" data-path="api/replacements" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-replacements" onclick="tryItOut('GETapi-replacements');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-replacements" onclick="cancelTryOut('GETapi-replacements');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-replacements" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-replacements" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-replacements"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-replacements"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-replacements" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-replacements"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-replacements" data-method="POST" data-path="api/replacements" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-replacements" onclick="tryItOut('POSTapi-replacements');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-replacements" onclick="cancelTryOut('POSTapi-replacements');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-replacements" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-replacements" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-replacements"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-replacements"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="tanggal" data-endpoint="POSTapi-replacements"
                        value="2026-05-20T05:58:38" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-replacements"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-replacements" value="B"
                        data-component="body">
                    <br>
                    <p>Example: <code>B</code></p>
                    Must be one of:
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="target_machine" data-endpoint="POSTapi-replacements"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="member_id" data-endpoint="POSTapi-replacements"
                        value="architecto" data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the members table. Example: <code>architecto</code>
                    </p>
                </div>
            </form>
            ...
            <span id="example-requests-DELETEapi-replacements--replacement_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request DELETE \
    "http://192.168.247.152:8000/api/replacements/9" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-replacements--replacement_id-" data-method="DELETE"
                data-path="api/replacements/{replacement_id}" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-replacements--replacement_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-replacements--replacement_id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="replacement_id"
                        data-endpoint="DELETEapi-replacements--replacement_id-" value="9" data-component="url">
                    <br>
            ...
            <span id="example-requests-GETapi-sections">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/sections" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/sections"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-sections" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-sections"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-sections" data-method="GET" data-path="api/sections" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-sections" onclick="tryItOut('GETapi-sections');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-sections" onclick="cancelTryOut('GETapi-sections');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-sections" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-sections" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-sections"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-sections"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-sections" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-sections"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-sections" data-method="POST" data-path="api/sections" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-sections" onclick="tryItOut('POSTapi-sections');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-sections" onclick="cancelTryOut('POSTapi-sections');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-sections" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-sections" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-sections"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-sections"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="factory_id"
                        data-endpoint="POSTapi-sections" value="16" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-sections" value="n"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="code" data-endpoint="POSTapi-sections" value="g"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="type" data-endpoint="POSTapi-sections"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
            ...
            <span id="example-requests-PUTapi-sections--section_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PUT \
    "http://192.168.247.152:8000/api/sections/9" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PUTapi-sections--section_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-sections--section_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-sections--section_id-" data-method="PUT" data-path="api/sections/{section_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-sections--section_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PUTapi-sections--section_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-sections--section_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-sections--section_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="section_id"
                        data-endpoint="PUTapi-sections--section_id-" value="9" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="PUTapi-sections--section_id-"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="code" data-endpoint="PUTapi-sections--section_id-"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="type" data-endpoint="PUTapi-sections--section_id-"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-sections--section_id-" data-method="DELETE" data-path="api/sections/{section_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-sections--section_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-sections--section_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-sections--section_id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="section_id"
                        data-endpoint="DELETEapi-sections--section_id-" value="9" data-component="url">
                    <br>
                    <p>The ID of the section. Example: <code>9</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-PATCHapi-sections-reorder">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PATCH \
    "http://192.168.247.152:8000/api/sections/reorder" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PATCHapi-sections-reorder" hidden>
                <blockquote>Received response<span id="execution-response-status-PATCHapi-sections-reorder"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PATCHapi-sections-reorder" data-method="PATCH" data-path="api/sections/reorder"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PATCHapi-sections-reorder" onclick="tryItOut('PATCHapi-sections-reorder');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PATCHapi-sections-reorder" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PATCHapi-sections-reorder" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PATCHapi-sections-reorder" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PATCHapi-sections-reorder"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    <details>
                        ...
                        <div style="margin-left: 14px; clear: unset;">
                            ...
                            &nbsp;
                            <input type="number" style="display: none" step="any" name="order.0.id"
                                data-endpoint="PATCHapi-sections-reorder" value="16" data-component="body">
                            <br>
                            <p>The <code>id</code> of an existing record in the sections table. Example: <code>16</code>
                            </p>
                        </div>
                        <div style="margin-left: 14px; clear: unset;">
                            <b style="line-height: 2;"><code>order_index</code></b>&nbsp;&nbsp;
            ...
            <span id="example-requests-GETapi-statuses">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/statuses" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/statuses"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-statuses" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-statuses"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-statuses" data-method="GET" data-path="api/statuses" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-statuses" onclick="tryItOut('GETapi-statuses');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-statuses" onclick="cancelTryOut('GETapi-statuses');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-statuses" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-statuses" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-statuses"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-statuses"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-POSTapi-statuses" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-statuses"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-statuses" data-method="POST" data-path="api/statuses" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-statuses" onclick="tryItOut('POSTapi-statuses');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-statuses" onclick="cancelTryOut('POSTapi-statuses');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-statuses" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-statuses" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-statuses"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-statuses"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="key" data-endpoint="POSTapi-statuses" value="b"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="label" data-endpoint="POSTapi-statuses" value="n"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="icon" data-endpoint="POSTapi-statuses" value="gzmiyv"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="color" data-endpoint="POSTapi-statuses" value="d"
                        data-component="body">
                    <br>
            ...
            <span id="example-requests-PUTapi-statuses--status_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request PUT \
    "http://192.168.247.152:8000/api/statuses/1" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PUTapi-statuses--status_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-statuses--status_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-statuses--status_id-" data-method="PUT" data-path="api/statuses/{status_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-statuses--status_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PUTapi-statuses--status_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-statuses--status_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-statuses--status_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="status_id"
                        data-endpoint="PUTapi-statuses--status_id-" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="key" data-endpoint="PUTapi-statuses--status_id-"
                        value="" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="label" data-endpoint="PUTapi-statuses--status_id-"
                        value="b" data-component="body">
                    <br>
                    <p>Must not be greater than 100 characters. Example: <code>b</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="icon" data-endpoint="PUTapi-statuses--status_id-"
                        value="ngzmiy" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="color" data-endpoint="PUTapi-statuses--status_id-"
                        value="v" data-component="body">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-statuses--status_id-" data-method="DELETE" data-path="api/statuses/{status_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-statuses--status_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-statuses--status_id-" value="{HMAC_SHA256_TOKEN}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-statuses--status_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="status_id"
                        data-endpoint="DELETEapi-statuses--status_id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the status. Example: <code>1</code></p>
                </div>
            </form>
            ...
            <span id="example-requests-GETapi-users">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/users" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/users"
);
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-users" data-method="GET" data-path="api/users" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-users" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
            ...
            <span id="example-requests-GETapi-users--user_id-">
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://192.168.247.152:8000/api/users/1" \
    --header "X-App-Secret: {HMAC_SHA256_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://192.168.247.152:8000/api/users/1"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-users--user_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-users--user_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-users--user_id-" data-method="GET" data-path="api/users/{user_id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-users--user_id-" onclick="tryItOut('GETapi-users--user_id-');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-users--user_id-" onclick="cancelTryOut('GETapi-users--user_id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-users--user_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="GETapi-users--user_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-users--user_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-users--user_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="GETapi-users--user_id-" value="1" data-component="url">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-users" data-method="POST" data-path="api/users" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="POSTapi-users" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-users" value="b"
                        data-component="body">
                    <br>
                    <p>Must not be greater than 100 characters. Example: <code>b</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="username" data-endpoint="POSTapi-users" value="n"
                        data-component="body">
                    <br>
                    <p>Must contain only letters, numbers, dashes and underscores. Must not be greater than 50
                        characters. Example: <code>n</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="password" data-endpoint="POSTapi-users"
                        value="|{+-0pBNvYgx" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="POSTapi-users" value=""
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="POSTapi-users" value=""
                        data-component="body">
                    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-PUTapi-users--user_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-users--user_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-users--user_id-" data-method="PUT" data-path="api/users/{user_id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PUTapi-users--user_id-" onclick="tryItOut('PUTapi-users--user_id-');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-PUTapi-users--user_id-" onclick="cancelTryOut('PUTapi-users--user_id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-users--user_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="PUTapi-users--user_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="PUTapi-users--user_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-users--user_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="PUTapi-users--user_id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the user. Example: <code>1</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="PUTapi-users--user_id-"
                        value="b" data-component="body">
                    <br>
                    <p>Must not be greater than 100 characters. Example: <code>b</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="username" data-endpoint="PUTapi-users--user_id-"
                        value="n" data-component="body">
                    <br>
                    <p>Must contain only letters, numbers, dashes and underscores. Must not be greater than 50
                        characters. Example: <code>n</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="role" data-endpoint="PUTapi-users--user_id-"
                        value="architecto" data-component="body">
                    <br>
                    <p>Example: <code>architecto</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="password" data-endpoint="PUTapi-users--user_id-"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="factory" data-endpoint="PUTapi-users--user_id-"
                        value="" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <i>optional</i> &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="shift" data-endpoint="PUTapi-users--user_id-"
                        value="" data-component="body">
                    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-DELETEapi-users--user_id-" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-users--user_id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-users--user_id-" data-method="DELETE" data-path="api/users/{user_id}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-DELETEapi-users--user_id-" onclick="tryItOut('DELETEapi-users--user_id-');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-users--user_id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="X-App-Secret" class="auth-value"
                        data-endpoint="DELETEapi-users--user_id-" value="{HMAC_SHA256_TOKEN}" data-component="header">
                    <br>
                    <p>Example: <code>{HMAC_SHA256_TOKEN}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-users--user_id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-users--user_id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="DELETEapi-users--user_id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the user. Example: <code>1</code></p>
                </div>
            </form>
