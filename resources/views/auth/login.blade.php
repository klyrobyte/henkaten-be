...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700;900&family=Roboto:wght@300;400;500;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        body {
            margin: 0;
            min-height: 100vh;
            background: linear-gradient(135deg, #2E7D32, #1F3C88);
            display: flex;
            align-items: center;
        ...
        .login-logo-img img {
            ...
            width: auto;
            object-fit: contain;
            filter: drop-shadow(0 2px 8px rgba(31, 60, 136, .18));
        }
        ...
        .login-btn {
            ...
            border: none;
            border-radius: 12px;
            background: linear-gradient(135deg, #729E3F, #2E7D32);
            color: #fff;
            font-size: 16px;
            font-weight: 700;
            cursor: pointer;
