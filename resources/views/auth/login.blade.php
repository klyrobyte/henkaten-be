...
.login-logo-img { display: flex; justify-content: center; margin-bottom: 14px; }
.login-logo-img img { height: 52px; width: auto; object-fit: contain; filter: drop-shadow(0 2px 8px rgba(31,60,136,.18)); }
