...
@push('styles')
    <style>
        /* @rizkydaffy: table layout matching skillmap.png — uses theme tokens only */
        .stm-table-wrap {
            border-radius: 12px;
        ...
        .stm-add-btn {
            ...
            letter-spacing: .5px;
            cursor: pointer;
            box-shadow: 0 3px 12px rgba(var(--brand-primary-rgb), .35);
        ...
        .stm-save-btn {
            ...
            margin-top: 6px;
            margin-bottom: 18px;
            box-shadow: 0 4px 14px rgba(var(--brand-primary-rgb), .35);
...
@section('content')
    <div style="padding: 6px 0 110px;">
        ...
        {{-- @rizkydaffy: table layout matching skillmap.png reference --}}
                            ...
                            <td>
                                <div class="stm-row-actions">
                                    <button class="stm-act-btn stm-act-edit"
                                        onclick="openStatusModal({{ $st->id }}, '{{ addslashes($st->key) }}', '{{ addslashes($st->label) }}', '{{ addslashes($st->icon) }}', '{{ addslashes($st->color) }}')">✏️
                                        Edit</button>
                                    <button class="stm-act-btn stm-act-del"
                                        onclick="deleteStatus({{ $st->id }}, '{{ addslashes($st->label) }}')">🗑️</button>
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="7" class="stm-empty">
                                <div class="stm-empty-icon">🏷️</div>Belum ada status. Klik <strong>Tambah Status</strong> untuk
                                mulai.
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="modal-sheet" style="max-height:92vh;overflow-y:auto">
            ...
            <div class="mm-modal-body">
                ...
                <div class="stm-field">
                    ...
                    <small style="color:#888;font-size:10px;font-family:'Roboto Condensed',sans-serif;">Lowercase, tanpa
                        spasi. Harus sama dengan nilai kolom <strong>status</strong> di tabel mesin.</small>
                </div>
                ...
                <div class="stm-field">
                    ...
                    <div class="stm-color-row">
                        <input type="text" id="stmColor" placeholder="#1f3c88" autocomplete="off"
