...
<div style="margin-bottom:80px">
    ...
    <div class="log-summary-bar">
        ...
        <div class="lsb-item">
            <div class="lsb-val" style="color:#1f3c88" id="cntMachine">{{ $logs->where('jenis', 'Machine')->count() }}
            </div>
        ...
        <div class="lsb-item">
            <div class="lsb-val" style="color:#2e7d32" id="cntMethod">{{ $logs->where('jenis', 'Method')->count() }}
            </div>
        ...
        <div class="log-card {{ $log->status }}" id="logcard-{{ $log->id }}">
            <div class="log-card-top">
                ...
                <span class="log-time" id="time-{{ $log->id }}">
                    {{ substr($log->waktu_mulai, 0, 5) }}{{ $log->waktu_selesai ? ' – ' . substr($log->waktu_selesai, 0,
                    5) : ' – …' }}
                </span>
                @if($log->durasi)
