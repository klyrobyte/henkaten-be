                    ...
                    @else
                        @foreach($r['absen_list'] as $m)
                            ...
                            <div style="display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid #f0f0f0">
                                <div
                                    style="width:34px;height:34px;border-radius:50%;overflow:hidden;background:linear-gradient(135deg,#ef9a9a,#c0392b);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:900;color:#fff;flex-shrink:0;font-family:'Roboto Condensed',sans-serif;">
                                    {{ mb_strtoupper(mb_substr($m->nama ?? '?', 0, 1)) }}
                                </div>
                                <div style="flex:1;min-width:0">
                                    <div
                                        style="font-size:12px;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
                                        {{ $m->nama }}
                                    </div>
                                ...
                                <span
                                    style="background:{{ $dotColors[$m->reason ?? ''] ?? '#888' }};color:#fff;padding:3px 9px;border-radius:6px;font-size:10px;font-weight:700;flex-shrink:0;font-family:'Roboto Condensed',sans-serif;">
                                    {{ $m->reason ?? '-' }}
                                </span>
                            </div>
                        @endforeach
