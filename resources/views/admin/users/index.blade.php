...
@push('styles')
    <style>
        ...
        .um-add-btn {
            ...
            letter-spacing: .5px;
            cursor: pointer;
            box-shadow: 0 3px 10px rgba(31, 60, 136, .3);
                    ...
                    @forelse($users as $u)
                        ...
                        <tr id="um-row-{{ $u->id }}">
                                ...
                                <div class="um-name-col">
                                    ...
                                    <div>
                                        <div class="um-name-txt">
                                            ...
                                            @if($isSelf)
                                                <span
                                                    style="font-size:9px;background:#eee;color:#888;padding:1px 5px;border-radius:4px;font-weight:700">KAMU</span>
                                            @endif
                                        </div>
                            ...
                            <td style="text-align:right;white-space:nowrap">
                                ...
                                @if($isSelf)
                                    <button class="um-action-btn um-btn-self" disabled
                                        title="Tidak bisa hapus akun sendiri">🚫</button>
                                @else
            ...
            <div class="um-modal-body">
                ...
                <div class="um-form-grid">
                    ...
                    <div class="um-field">
                        ...
                        <input type="password" id="umPasswordConfirm" placeholder="Ulangi password"
